#Desenvolva um programa que mostre todos os n´umeros entre 1 e 200 que s˜ao m´ultiplos de 3 ou de 5
...
div			$7, $11			#verifica se o numero atual é divisível por 3
mfhi	 	$10
beq 		$10, $0, imprime	#se for divisível vai para imprime
